...
const curriculumData = [
  {
    week: "Week 1",
    title: "The Story of Money – How It Works and Why It Matters",
  ...
  {
    week: "Week 4",
    title: "Personal Finances - How to plan like a pro",
...
const additionalWeeksData = [
  {
    week: "Week 5",
    title: "Smart Spending & Trade-Offs: Making Choices That Count",
